...
import yongfa365.jmeter.control.MarkdownDataDriverController;
...
public class MarkdownDataDriverControllerGui extends AbstractControllerGui {
    ...
    public String getStaticLabel() {
        return "Markdown Data Driver Controller";
    }
    ...
    public TestElement createTestElement() {
        MarkdownDataDriverController lc = new MarkdownDataDriverController();
    ...
    public void modifyTestElement(TestElement element) {
        ...
        if (element instanceof MarkdownDataDriverController) {
            MarkdownDataDriverController obj = (MarkdownDataDriverController) element;
            obj.setProperty(MarkdownDataDriverController.MARKDOWN_DATA, txtSyntax.getAsText());
        }
    }

    @Override
    public void configure(TestElement element) {
        txtSyntax.setAsText(element.getPropertyAsString(MarkdownDataDriverController.MARKDOWN_DATA));

        super.configure(element);
    }

    public MarkdownDataDriverControllerGui() {
        init();
    }
    ...
    private JPanel createBodyPanel() {
        ...
        JLabel label1 = new JLabel("Markdown Data，like 'While Controller',head will be the variable name");
