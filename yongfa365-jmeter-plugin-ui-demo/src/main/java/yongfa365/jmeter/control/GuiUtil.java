...
public class GuiUtil {
    ...
    public static class GridBag {
        ...
        public static GridBagConstraints allLineConstraints;  // for multi line editors
        ...
        static {
            ...
            allLineConstraints = new GridBagConstraints();
            allLineConstraints.fill = GridBagConstraints.BOTH;
            allLineConstraints.gridx = 0;
            allLineConstraints.gridy = GridBagConstraints.RELATIVE;
            allLineConstraints.gridwidth = 3;
            allLineConstraints.weightx = 1;
            allLineConstraints.insets = new Insets(1, 1, 1, 1);
